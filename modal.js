...
modaljs = function(title,body) {
  ...
  document.body.innerHTML = was + "<div id='openModal' class='modal'><div><a href='#close' title='Close' class='close'>X</a><h2 class='title'>" + title + "</h2><p class='body'>" + body + "</p></div></div>";
